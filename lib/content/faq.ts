export const formationFaq = [
  ...
  },
  {
    ...
    answer:
      "Modules vidéo, exercices d'incarnation, templates de négociation et accès à la communauté Pussycat Queens. Tu avances à ton rythme, avec un cadre clair.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "La formation inclut des sessions de questions-réponses en direct et l'accès à la communauté. Pour un accompagnement personnalisé, explore le coaching 1:1.",
  },
] as const;
...
export const coachingFaq = [
  ...
  },
  {
    ...
    answer:
      "En visio, 60 minutes. On identifie ce qui bloque, on clarifie ta vision, on construit des actions incarnées. Tu repars avec de la clarté et un plan.",
  },
  {
    question: "Quelle est la durée d'un accompagnement ?",
    answer:
      "Minimum 3 mois pour une transformation durable. Certains programmes s'étendent sur 6 mois selon tes objectifs.",
  },
] as const;
...
export const coachingSteps = [
  ...
  },
  {
    ...
    title: "Incarnation",
    description:
      "Présence, communication, négociation. On traduit la vision en actions concrètes.",
  },
  {
    step: "04",
    title: "Souveraineté",
    description:
      "Tu intègres. Tu décides. Tu ne demandes plus la permission.",
  },
] as const;
